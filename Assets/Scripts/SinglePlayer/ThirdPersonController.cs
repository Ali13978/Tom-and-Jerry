...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("speed of mouse while rotating character")]
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                _cinemachineTargetYaw += _input.look.x * mouseSenstivity * deltaTimeMultiplier;
                _cinemachineTargetPitch += _input.look.y * mouseSenstivity * deltaTimeMultiplier;
            }
        ...
        private void Move()
        {
            ...
            // update animator if using character
            if (_hasAnimator && GetComponent<BasicRigidBodyPush>().isPushing)
            {
                _animator.SetBool(_animIDisPushing, true);
            }

            else if (_hasAnimator && !GetComponent<BasicRigidBodyPush>().isPushing)
            {
